                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input disabled name="disiplin" type="number" min="0" max="10" class="form-control" id="disiplin" value="<?= $evaluation['disiplin'] ?>">
                                        </div>
                                    </div>
                                    <div class="mt-3 row">
                                        <label for="loyalitas" class="col-sm-4 col-form-label">Loyalitas</label>
                                        <div class="col-sm-6">
                                            <input disabled name="loyalitas" type="number" min="0" max="10" class="form-control" id="loyalitas" value="<?= $evaluation['loyalitas'] ?>">
                                        </div>
                                    </div>
                                    <div class="mt-3 row">
                                        <label for="kerjasama" class="col-sm-4 col-form-label">Kerja Sama</label>
                                        <div class="col-sm-6">
                                            <input disabled name="kerjasama" type="number" min="0" max="10" class="form-control" id="kerjasama" value="<?= $evaluation['kerjasama'] ?>">
                                        </div>
                                    </div>
                                    <div class="mt-3 row">
                                        <label for="perilaku" class="col-sm-4 col-form-label">Perilaku</label>
                                        <div class="col-sm-6">
                                            <input disabled name="perilaku" type="number" min="0" max="10" class="form-control" id="perilaku" value="<?= $evaluation['perilaku'] ?>">
                                        </div>
                                    </div>
                                    <div class="mt-5 row">
                                    ...
                                    <?php foreach ($job_result as $key => $value) : ?>
                                        <div class="multiple-form">
                                            <div id="after-add-more" class="control-group mt-3 row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input disabled style="width: 100%" id="type" name="value_job_type[]" type="number" min="0" max="100" class="form-control" value="<?= $job_result[$key]['job_score'] ?>">
