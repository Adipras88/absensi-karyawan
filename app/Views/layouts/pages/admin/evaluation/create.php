...
<div class="container-fluid">
  ...
  <?php if (session()->getFlashData('failed_evaluation')) : ?>
    <div class="alert success alert-danger" role="alert">
      <?php echo session("failed_evaluation") ?>
    </div>
  <?php endif; ?>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-3 row">
                    ...
                    <div class="col-sm-6">
                      <input name="disiplin" type="text" min="0" max="100" class="form-control" id="disiplin" readonly>
                  ...
                  <div class="mt-3 row">
                    ...
                    <div class="col-sm-6">
                      <input name="loyalitas" type="text" min="0" max="100" class="form-control numberonly" id="loyalitas">
                  ...
                  <div class="mt-3 row">
                    ...
                    <div class="col-sm-6">
                      <input name="kerjasama" type="text" min="0" max="100" class="form-control numberonly" id="kerjasama">
                  ...
                  <div class="mt-3 row">
                    ...
                    <div class="col-sm-6">
                      <input name="perilaku" type="text" min="0" max="100" class="form-control numberonly" id="perilaku">
                  ...
                  <div class="mt-5 row">
                    ...
                    <div class="col-sm-6">
                      <input readonly name="total_sikap" type="text" class="form-control" id="total">
                    </div>
                  </div>
                  <div class="mt-2 row">
                    <label for="total" class="col-sm-4 col-form-label font-bold">SCORE
                      40%</label>
                    <div class="col-sm-6">
                      <input readonly name="total_percentage_sikap" type="text" class="form-control" id="total_percentage_sikap">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="multiple-form">
                    <div id="after-add-more" class="control-group mt-3 row">
                      <div class="col-sm-5">
                        <select id="job_id" name="job_id[]" class="form-select <?= ($validation->hasError('job_id') ? 'is-invalid' : '') ?>">
                          <option value="">--please select--</option>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#employee").on('change', function() {
      ...
      $.ajax({
        url: "<?= base_url('absensiservices/countEvaluation/') ?>",
        method: "POST",
        data: {
          token: "3eb561821782ed487d59903770eac30d",
          id: this.value
        },
        success: function(response) {
          console.log(response);
          $("#disiplin").val(response.total_disiplin);
        },
        error: function() {
          console.log("error");
        }
  ...
  function onSubmitResultWork() {
    ...
    document.getElementById("total").value = (total / 4).toFixed(2);
    document.getElementById("total_percentage_sikap").value = (40 / 100 * document.getElementById("total").value).toFixed(2);
    ...
    document.getElementById("total_percentage_working_result").value = ((60 / 100) * (totalWorking / sum)).toFixed(2);
